...
"+--- Editor ---+
hi Normal guifg=#404b4e guibg=#fffefe

hi Cursor       guifg=#fffefe guibg=#2d2d2d
hi CursorLine   guifg=NONE    guibg=#e0f7d1
hi CursorColumn guifg=NONE    guibg=#e0f7d1
hi CursorLineNr guifg=#2d2d2d guibg=NONE    gui=NONE
hi LineNr       guifg=#aeaeae guibg=NONE

hi ColorColumn guifg=NONE    guibg=#ffffff gui=NONE
hi Error       guifg=#c8dde2 guibg=#c8233b
hi MatchParen  guifg=#0b1010 guibg=#2d8da1
hi NonText     guifg=#aeaeae               gui=NONE
hi Whitespace  guifg=#aeaeae               gui=NONE
...
hi String         guifg=#1d8e02 guibg=NONE gui=NONE
